	...
	public function testSafari() : void {
		$strings = [
			...
			'Mozilla/5.0 (iPhone; CPU iPhone OS 18_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/136.2 Mobile/15E148 Safari/605.1.15' => [
				'string' => 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/136.2 Mobile/15E148 Safari/605.1.15',
				'type' => 'human',
				'category' => 'mobile',
				'vendor' => 'Apple',
				'device' => 'iPhone',
				...
				'engineversion' => '605.1.15',
				'browser' => 'Firefox',
				'browserversion' => '136.2',
				'browserreleased' => '2025-03-04'
			],
			'Mozilla/5.0 (iPhone; CPU iPhone OS 18_4_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/135.0.7049.83 Mobile/15E148 Safari/604.1' => [
				'string' => 'Mozilla/5.0 (iPhone; CPU iPhone OS 18_4_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/135.0.7049.83 Mobile/15E148 Safari/604.1',
				'type' => 'human',
				'category' => 'mobile',
				'vendor' => 'Apple',
				'device' => 'iPhone',
				...
				'kernel' => 'Linux',
				'platform' => 'iOS',
				'platformversion' => '18.4.0',
				'engine' => 'WebKit',
				'engineversion' => '605.1.15',
				'browser' => 'Chrome',
				'browserversion' => '135.0.7049.83',
				'browserreleased' => '2025-04-15'
			],
			'Mozilla/5.0 (iPhone; CPU iPhone OS 16_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/135.0.7049.50 Version/16.0 Mobile/15E148 Safari/604.1' => [
				'string' => 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_7_2 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) EdgiOS/135.0.7049.50 Version/16.0 Mobile/15E148 Safari/604.1',
				'type' => 'human',
				'category' => 'mobile',
				'vendor' => 'Apple',
				'device' => 'iPhone',
				...
				'engineversion' => '605.1.15',
				'browser' => 'Edge',
				'browserversion' => '135.0.7049.50',
				'browserreleased' => '2025-04-24'
			]
		];
		foreach ($strings AS $ua => $item) {
			$this->assertEquals($item, lib::parse($ua), $ua);
